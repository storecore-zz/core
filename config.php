...
if (!defined('STORECORE_FILESYSTEM_CACHE_DIR')) {
    define('STORECORE_FILESYSTEM_CACHE_DIR', rtrim(__DIR__, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'cache' . DIRECTORY_SEPARATOR);
}
...
if (!defined('STORECORE_FILESYSTEM_LOGS_DIR')) {
    define('STORECORE_FILESYSTEM_LOGS_DIR', rtrim(__DIR__, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR);
}
