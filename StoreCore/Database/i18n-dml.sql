...
INSERT IGNORE INTO sc_translation_memory
  ...
  VALUES
    ...
    ('NOUN_GOOGLE_PRODUCT_TAXONOMY',   0, 'Google product taxonomy', 1),
    ('NOUN_GOOGLE_PRODUCT_TAXONOMY',   1, 'Google-producttaxonomie', 1),
    ('NOUN_GOOGLE_PRODUCT_TAXONOMY',   2, 'Google-Produkt-Taxonomie', 1),
    ('NOUN_GOOGLE_PRODUCT_TAXONOMY',   3, 'classification des produits Google', 1),
    ...
    ('NOUN_PASSWORD',   0, 'password', 1),
    ('NOUN_PASSWORD',   1, 'wachtwoord', 1),
    ('NOUN_PASSWORD',   2, 'Kennwort', 1),
    ('NOUN_PASSWORD',   3, 'mot de passe', 1),
...
-- 1st level (root) in American English en-US (255)
