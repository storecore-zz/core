...
INSERT IGNORE INTO sc_translation_memory
  ...
  VALUES
    ('ADJECTIVE_BOLD', 'en-GB', 'bold'),
    ('ADJECTIVE_BOLD', 'de-DE', 'fett'),
    ('ADJECTIVE_BOLD', 'es-ES', 'negrita'),
    ('ADJECTIVE_BOLD', 'fr-FR', 'gras'),
    ('ADJECTIVE_BOLD', 'it-IT', 'grassetto'),
    ('ADJECTIVE_BOLD', 'nl-NL', 'vet'),
    ('ADJECTIVE_BOLD', 'pt-PT', 'negrito'),

    ('ADJECTIVE_DEFAULT', 'en-GB', 'default'),
    ('ADJECTIVE_DEFAULT', 'de-DE', 'standard'),
    ('ADJECTIVE_DEFAULT', 'es-ES', 'predeterminado'),
    ('ADJECTIVE_DEFAULT', 'fr-FR', 'par défaut'),
    ('ADJECTIVE_DEFAULT', 'it-IT', 'impostazione predefinita'),
    ('ADJECTIVE_DEFAULT', 'nl-NL', 'standaard'),
    ('ADJECTIVE_DEFAULT', 'pt-PT', 'predefinição'),

    ('ADJECTIVE_FEMALE', 'en-GB', 'female'),
    ('ADJECTIVE_FEMALE', 'de-DE', 'weiblich'),
    ('ADJECTIVE_FEMALE', 'es-ES', 'femenino'),
    ('ADJECTIVE_FEMALE', 'fr-FR', 'féminin'),
    ('ADJECTIVE_FEMALE', 'it-IT', 'femmina'),
    ('ADJECTIVE_FEMALE', 'nl-NL', 'vrouwelijk'),
    ('ADJECTIVE_FEMALE', 'pt-PT', 'feminino'),

    ('ADJECTIVE_MALE', 'en-GB', 'male'),
    ('ADJECTIVE_MALE', 'de-DE', 'männlich'),
    ('ADJECTIVE_MALE', 'es-ES', 'masculino'),
    ('ADJECTIVE_MALE', 'fr-FR', 'masculin'),
    ('ADJECTIVE_MALE', 'it-IT', 'maschio'),
    ...
    ('ADJECTIVE_UNKNOWN', 'fr-FR', 'inconnu'),
    ('ADJECTIVE_UNKNOWN', 'it-IT', 'sconosciuto'),
...
INSERT IGNORE INTO sc_translation_memory
  ...
  VALUES
    ...
    ('NOUN_DATABASE', 'fr-FR', 'base de données', 1),
    ('NOUN_DATABASE', 'it-IT', 'database', 1),
    ...
    ('NOUN_DEFAULT_TIMEZONE', 'fr-FR', 'fuseau horaire par défaut', 1),
    ('NOUN_DEFAULT_TIMEZONE', 'it-IT', 'fuso orario predefinito', 1),
    ...
    ('NOUN_ENERGY_EFFICIENCY_CLASS', 'fr-FR', 'classe énergétique', 0),
    ('NOUN_ENERGY_EFFICIENCY_CLASS', 'it-IT', 'classe energetica', 0),
    ...
    ('NOUN_GENDER', 'fr-FR', 'sexe', 0),
    ('NOUN_GENDER', 'it-IT', 'sesso', 0),
    ...
    ('NOUN_LATITUDE', 'fr-FR', 'latitude', 0),
    ('NOUN_LATITUDE', 'it-IT', 'latitudine', 0),
    ...
    ('NOUN_LONGITUDE', 'fr-FR', 'longitude', 0),
    ('NOUN_LONGITUDE', 'it-IT', 'longitudine', 0),
    ...
    ('NOUN_PASSWORD', 'fr-FR', 'mot de passe', 0),
    ('NOUN_PASSWORD', 'it-IT', 'password', 0),
    ...
    ('NOUN_POSTAL_CODE', 'es-ES', 'código postal', 0),
    ('NOUN_POSTAL_CODE', 'fr-FR', 'code postal', 0),
    ('NOUN_POSTAL_CODE', 'it-IT', 'CAP', 0),
    ...
    ('NOUN_SHOPPING_CART', 'fr-FR', 'chariot', 0),
    ...
    ('NOUN_TRACKING_NUMBER', 'fr-FR', 'numéro de suivi', 0),
    ('NOUN_TRACKING_NUMBER', 'it-IT', 'numero di tracciabilità', 0),
    ...
    ('NOUN_USER', 'fr-FR', 'utilisateur', 0),
    ('NOUN_USER', 'it-IT', 'utente', 0),
...
INSERT IGNORE INTO sc_translation_memory
  ...
  VALUES
    ...
    ('VERB_CANCEL', 'fr-FR', 'annuler'),
    ('VERB_CANCEL', 'it-IT', 'annullare'),
...
INSERT IGNORE INTO sc_translation_memory
  ...
  VALUES
    ...
    ('COMMAND_CANCEL', 'fr-FR', 'Annuler'),
    ('COMMAND_CANCEL', 'it-IT', 'Annulla'),
    ...
    ('COMMAND_DELETE', 'fr-FR', 'Supprimer'),
    ('COMMAND_DELETE', 'nl-NL', 'Verwijderen'),
    ...
    ('COMMAND_NEXT', 'fr-FR', 'Suivant'),
    ('COMMAND_NEXT', 'nl-NL', 'Volgende'),
    ...
    ('COMMAND_SAVE', 'fr-FR', 'Enregistrer'),
    ('COMMAND_SAVE', 'it-IT', 'Salva'),
    ...
    ('COMMAND_SIGN_IN', 'fr-FR', 'Se connecter'),
    ('COMMAND_SIGN_IN', 'it-IT', 'Accedi'),
    ...
    ('COMMAND_SIGN_OUT', 'fr-FR', 'Se déconnecter'),
    ('COMMAND_SIGN_OUT', 'it-IT', 'Disconnessione'),
    ...
    ('COMMAND_UNLOCK', 'fr-FR', 'Déverrouiller…'),
    ('COMMAND_UNLOCK', 'it-IT', 'Sblocca…'),
...
INSERT IGNORE INTO sc_translation_memory
    (translation_id, language_id, translation)
  VALUES
    ('ERROR_PASSWORD_CHARACTERS', 'de-DE', 'Das Kennwort muss sowohl Zahlen als auch Buchstaben enthalten.'),
    ('ERROR_PASSWORD_CHARACTERS', 'en-GB', 'The password must contain both numbers and letters.'),
    ('ERROR_PASSWORD_CHARACTERS', 'es-ES', 'La contraseña debe contener números y letras.'),
    ('ERROR_PASSWORD_CHARACTERS', 'fr-FR', 'Le mot de passe doit contenir des chiffres et des lettres.'),
    ('ERROR_PASSWORD_CHARACTERS', 'it-IT', 'La password deve contenere sia numeri che lettere.'),
    ('ERROR_PASSWORD_CHARACTERS', 'nl-NL', 'Het wachtwoord moet cijfers en letters bevatten.'),

    ('ERROR_PASSWORD_MIN_LENGTH', 'de-DE', 'Das Kennwort muss aus mindestens 7 Zeichen bestehen.'),
    ('ERROR_PASSWORD_MIN_LENGTH', 'en-GB', 'The password must be at least 7 characters long.'),
    ('ERROR_PASSWORD_MIN_LENGTH', 'fr-FR', 'Le mot de passe doit être composé d’au moins 7 caractères.'),
    ('ERROR_PASSWORD_MIN_LENGTH', 'nl-NL', 'Het wachtwoord moet minimaal 7 tekens bevatten.'),

    ('ERROR_PASSWORD_TOO_COMMON', 'de-DE', 'Das Kennwort ist zu allgemein.'),
    ('ERROR_PASSWORD_TOO_COMMON', 'en-GB', 'The password is too common.'),
...
INSERT IGNORE INTO sc_translation_memory
  ...
  VALUES
    ...
    ('HEADING_CONFIRM_PASSWORD', 'fr-FR', 'Confirmer le mot de passe'),
    ...
    ('HEADING_EMAIL_ADDRESS', 'fr-FR', 'Adresse de messagerie'),
    ('HEADING_EMAIL_ADDRESS', 'it-IT', 'Indirizzo di posta elettronica'),
    ...
    ('HEADING_FIRST_NAME', 'fr-FR', 'Prénom'),
    ('HEADING_FIRST_NAME', 'it-IT', 'Nome'),
    ...
    ('HEADING_LANGUAGE', 'fr-FR', 'Langue'),
    ('HEADING_LANGUAGE', 'it-IT', 'Lingua'),
    ...
    ('HEADING_LAST_NAME', 'fr-FR', 'Nom'),
    ('HEADING_LAST_NAME', 'it-IT', 'Cognome'),
    ...
    ('HEADING_LOG_FILES', 'fr-FR', 'Fichiers journaux'),
    ('HEADING_LOG_FILES', 'it-IT', 'File di registro'),
    ...
    ('HEADING_ORDERS', 'fr-FR', 'Ordres'),
    ('HEADING_ORDERS', 'it-IT', 'Ordini'),
    ...
    ('HEADING_PASSWORD', 'fr-FR', 'Mot de passe'),
    ('HEADING_PASSWORD', 'it-IT', 'Password'),
    ...
    ('HEADING_USER_ACCOUNT', 'fr-FR', 'Compte d’utilisateur'),
    ('HEADING_USER_ACCOUNT', 'it-IT', 'Account utente'),
    ...
    ('HEADING_USERNAME', 'fr-FR', 'Nom d’utilisateur'),
    ('HEADING_USERNAME', 'it-IT', 'Nome utente'),
    ('HEADING_USERNAME', 'nl-NL', 'Gebruikersnaam'),
    ('HEADING_USERNAME', 'pt-PT', 'Nome de utilizador');
...
INSERT IGNORE INTO sc_translation_memory
  ...
  VALUES
    ...
    ('HEADING_CATALOG', 'fr-FR', 'Catalogue', 1),
    ('HEADING_CATALOG', 'it-IT', 'Catalogo', 1),
    ...
    ('HEADING_CUSTOMERS', 'fr-FR', 'Clients', 1),
    ('HEADING_CUSTOMERS', 'it-IT', 'Clienti', 1),
    ...
    ('HEADING_DATABASE_NAME', 'fr-FR', 'Nom de la base de données', 1),
    ('HEADING_DATABASE_NAME', 'it-IT', 'Nome database', 1),
    ...
    ('HEADING_DATABASE_SETTINGS', 'fr-FR', 'Paramètres de la base de données', 1),
    ('HEADING_DATABASE_SETTINGS', 'it-IT', 'Impostazioni database', 1),
    ...
    ('HEADING_LANGUAGES', 'fr-FR', 'Langues', 1),
    ('HEADING_LANGUAGES', 'it-IT', 'Lingue', 1),
    ...
    ('HEADING_HOST_NAME_OR_IP_ADDRESS', 'fr-FR', 'Nom d’hôte ou adresse IP', 1),
    ('HEADING_HOST_NAME_OR_IP_ADDRESS', 'it-IT', 'Nome host o indirizzo IP', 1),
    ...
    ('HEADING_PDO_DRIVER', 'fr-FR', 'Pilote PDO', 1),
    ('HEADING_PDO_DRIVER', 'it-IT', 'Driver PDO', 1),
    ...
    ('HEADING_SETTINGS', 'fr-FR', 'Paramètres', 1),
